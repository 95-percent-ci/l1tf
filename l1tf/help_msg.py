...
Keys for Help messages that will be used by Python command line argument parser

This module stores necessary keys for help messages that could be displayed in command line if user wants to
"""
